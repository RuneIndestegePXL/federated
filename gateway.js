...
const gateway = new ApolloGateway({
    supergraphSdl: new IntrospectAndCompose({
        subgraphs: [
            { name: 'order-service', url: "https://order-service.usecase-ace.svc.cluster.local:8443/graphql" },
            { name: 'crm-proxy', url: "https://crm-proxy.usecase-ace.svc.cluster.local:8443/graphql" },
